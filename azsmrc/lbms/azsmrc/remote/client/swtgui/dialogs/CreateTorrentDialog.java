...
public class CreateTorrentDialog {
	...
	private void createPage0(Composite parentComp){		
		...
		Composite fileDirComp = new Composite(settingsComp, SWT.NULL);
		fileDirComp.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		fileDirComp.setLayout(new GridLayout(2,true));
		
		Button bFile = new Button(fileDirComp, SWT.RADIO);
		...
		Button bDir = new Button(fileDirComp, SWT.RADIO);
		...
		//Separator
		Label separatorLabel3 = new Label(settingsComp, SWT.SEPARATOR | SWT.HORIZONTAL);
		separatorLabel3.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
