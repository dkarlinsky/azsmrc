...
public class RemoteConstants {
	...
	public static final String	OSName													= System
																								.getProperty("os.name");

	public static final boolean	isOSX													= OSName
																								.equalsIgnoreCase("Mac OS X");
	public static final boolean	isLinux													= OSName
																								.equalsIgnoreCase("Linux");
	public static final boolean	isSolaris												= OSName
	...
	public static final boolean	isWindows2003											= OSName
																								.equalsIgnoreCase("Windows 2003");
	...
	public static final boolean	isWindows9598ME											= isWindows95
																								|| isWindows98
																								|| isWindowsME;

	public static final boolean	isWindows												= !(isOSX
																								|| isLinux || isSolaris);
	...
	public static final int		ST_ALL_SEEDS											= ST_SEEDS
																								| ST_TOTAL_SEEDS;
	public static final int		ST_ALL_LEECHER											= ST_LEECHER
																								| ST_TOTAL_LEECHER;
	...
	// User Rights
	/**
	 * Is Admin, Admins can do everything, so all rights apply to non admin
	 * users only
	 */
	...
	/**
	 * Enables the user to add a Download as public Download
	 */
	public static final int		RIGHTS_ADD_PUBLICDL										= 1 << 4;
