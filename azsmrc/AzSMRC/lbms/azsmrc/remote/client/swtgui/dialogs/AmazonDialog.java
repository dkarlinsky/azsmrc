...
public class AmazonDialog {
	...
	public AmazonDialog(Display display){
		...
		infoLabel.setText("Dein Browser sollte die Amazon Website mit unserern referral Daten geöffnet haben.\n" +
				"Mit ein klein wenig mehr Aufwand kannst Du uns noch mehr unterstützen:\n" +
				"Wenn ein Artikel per DirektLink gekauft wird erhöht das die Provision um 2,5%");
		...
		info1.setText("Und so Funktioniert es:\n\n" +
				"Geh auf die Amazon Website und such dir ein Produkt aus:\n\n" +
				"Jetzt brauchst nur noch die ASIN des Artikels.\n" +
				"Hier ein Amazon link:\n" +
				"http://www.amazon.de/exec/obidos/ASIN/B000AAXGP6/\n" +
				"Diese findest Du hinter ASIN/ also hier B000AAXGP6,\n" +
				"diese gibts Du dann einfach unten in das Textfeld ein und drückst auf 'Einkaufen'.\n" +
				"Wenn Du mehrere Artikel kaufen willst solltest du diesen schritt wiederhohlen.");
		...
		productNumL.setText("Hier ASIN eingeben:");
