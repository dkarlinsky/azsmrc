...
public class GUIAdminShells {
            ...
            public void run() {
                ...
                Plugin.getDisplay().asyncExec( new Runnable() {
                    public void run() {
                        ...
                        OLD_INTERVAL = Plugin.getPluginInterface().getPluginconfig().getPluginIntParameter("user_dir_scan_time", 60);
                        ...
                        //composite for shell
                        final Composite config_composite = new Composite(shell,SWT.NULL);
                        ...
                        //shell title                        
                        shell.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.configDialog.title"));
                        
                        
                        final SashForm form = new SashForm(config_composite,SWT.HORIZONTAL);
                        ...
                        Tree tree = new Tree (child1, SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL);
                        gridData = new GridData(GridData.FILL_BOTH);
                        ...
                        item1.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.configDialog.treeItem.generalSettings"));
                        
                        //Download Slots TreeItem
                        TreeItem item2 = new TreeItem(tree,SWT.NONE);
                        item2.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.configDialog.treeItem.slotSettings"));
                        ...
                        tree.addListener (SWT.Selection, new Listener () {
                            public void handleEvent (Event event) {
                                ...
                                if(tempItem.getText().equalsIgnoreCase(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.configDialog.treeItem.generalSettings"))){
                        ...
                        cancel.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.configDialog.button.close"));
                        ...
                        shell.addListener(SWT.Dispose, new Listener() {
                           public void handleEvent(Event event) {
                               ...
                               if(OLD_INTERVAL != Plugin.getPluginInterface().getPluginconfig().getPluginIntParameter("user_dir_scan_time", 60)){
    ...
    public static void openGeneralSettingsDialog(Composite parent){
        ...
        grayLabel.setBackground(Plugin.getDisplay().getSystemColor(SWT.COLOR_GRAY));
        ...
        title.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.configDialog.treeItem.generalSettings"));
        ...
        Font newFont = new Font(Plugin.getDisplay(), fontData);
        ...
        timerLabel.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.generalSettings.timerLabel"));
        ...
        timerText.setText(String.valueOf(Plugin.getPluginInterface().getPluginconfig().getPluginIntParameter("user_dir_scan_time", 60) / 60));
        gridData = new GridData(GridData.HORIZONTAL_ALIGN_BEGINNING);
        ...
        timerText.addListener (SWT.Modify, new Listener () {
            public void handleEvent (Event e) {
                try{
                    ...
                    if(time > 0){
                        Plugin.getPluginInterface().getPluginconfig().setPluginParameter("user_dir_scan_time", (int)time * 60 );
                        System.out.println("Interval set to: " +  time*60  + " seconds");
                    }
    ...
    private static void openSlotShell(Composite parent){
        ...
        Label title = new Label(grayLabel,SWT.NONE);
        title.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.configDialog.treeItem.slotSettings"));
        title.setBackground(grayLabel.getBackground());
        ...
        nameLabel.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.slotShell.nameLabel"));
        
        //Grab the total slots from Azureus
        int azureus_slots = Plugin.getPluginInterface().getPluginconfig().getIntParameter("Max Downloads");
        if(azureus_slots > 25) {
            azureus_slots = 25;
            Plugin.getPluginInterface().getPluginconfig().setIntParameter("Max Downloads", azureus_slots);
        }
        
        
        
        final CustomSpinner totalSlots = new CustomSpinner(slot_composite, SWT.NULL);
        ...
        totalSlots.addListener (SWT.Selection, new Listener () {
            public void handleEvent (Event event) {
                ...
                Plugin.getPluginInterface().getPluginconfig().setIntParameter("Max Downloads", totalSlots.getSelection());
        ...
        warningLabel.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.slotShell.warningLabel"));
        warningLabel.setForeground(Plugin.getDisplay().getSystemColor(SWT.COLOR_DARK_RED));
        
        
        
        
        //-------------Table for users-------------\\
        users_table = new Table(slot_composite, SWT.H_SCROLL | SWT.BORDER | SWT.HIDE_SELECTION);
        gridData = new GridData(GridData.FILL_BOTH);
        ...
        userName.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.slotShell.userName"));
        userName.setWidth(200);
        
        TableColumn userSlots = new TableColumn(users_table,SWT.CENTER);
        userSlots.setText(Plugin.getLocaleUtilities().getLocalisedMessageText("GUIAdminShell.slotShell.userSlots"));
        ...
        for(int i = 0; i < users.length; i++){
            ...
            try {
                ...
                final CustomSpinner spinner = new CustomSpinner(users_table,SWT.NULL);
                ...
                spinner.addListener (SWT.Selection, new Listener () {
                    public void handleEvent (Event event) {
                        ...
                        }else if(spinner.getSelection() == spinner.getMinimum()){
                        ...
                        if(totalSlots.getSelection() < totalCount){
                            ...
                            Plugin.getPluginInterface().getPluginconfig().setIntParameter("Max Downloads", totalCount);
